...
= f_{i,j}\\\\"""
    ...
    eq = eq.replace('i+1', str(i + 1)).replace('i-1', str(i - 1)).replace('i+\\frac{1}{2}', str(i + 0.5)).replace(
        'i-\\frac{1}{2}', str(i - 0.5)).replace('i', str(i))
    eq = eq.replace('j+1', str(j + 1)).replace('j-1', str(j - 1)).replace('j+\\frac{1}{2}', str(j + 0.5)).replace(
        'j-\\frac{1}{2}', str(j - 0.5)).replace('j', str(j))
